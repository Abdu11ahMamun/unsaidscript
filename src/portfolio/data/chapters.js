...
export const CHAPTERS = [
  { year:"2014 – 2016", icon:"🕯️", color:C.gold, title:"The First Spark",
    text:"Class nine. Books found me before I found them. Then came The Forty Rules of Love — Elif Shafak, Rumi, Shams — and reading stopped being a hobby. It became a search for meaning, a quiet path that always led back to Allah and His Rasul ﷺ." },
  { year:"The Teenage Years", icon:"🌼", color:C.coral, title:"Himu's Yellow Panjabi",
    text:"Humayun Ahmed's Himu walked barefoot through my teenage years, and Misir Ali asked the questions I didn't know I had. Narendranath Mitra, Sharatchandra, Bankim, Bibhutibhushan... and then Rabindranath — after him, I finally understood why the world handed him a Nobel." },
  { year:"Magic & Melancholy", icon:"🌙", color:C.sky, title:"Murakami's Wells, Kafka's Rooms",
